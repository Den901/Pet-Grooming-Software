...
Release corrente: `0.0.1 beta 22` (`0.0.1-beta.22`).
...
- personalizzazione logo, colori, tema chiaro/scuro con accenti cromatici, sfondo login, dimensione interfaccia desktop/tablet, nome portale e dati azienda;
- aggiornamento live multiutente di schede, appuntamenti, utenti e impostazioni;
- calendario appuntamenti con vista giorno planning orario, settimana e mese compatto, vista desktop/iPad e agenda compatta su iPhone;
...
- `Pet-Grooming-Software-0.0.1-beta.22-windows.zip`;
- `Pet-Grooming-Software-0.0.1-beta.22-linux.tar.gz`;
- `Pet-Grooming-Software-0.0.1-beta.22.pgs-update`;
...
1. Estrai `Pet-Grooming-Software-0.0.1-beta.22-windows.zip`.
...
1. Copia `Pet-Grooming-Software-0.0.1-beta.22-linux.tar.gz` sul server.
2. Estrai il pacchetto e entra nella cartella:

```bash
tar -xzf Pet-Grooming-Software-0.0.1-beta.22-linux.tar.gz
cd Pet-Grooming-Software-0.0.1-beta.22
```
...
La release corrente e `0.0.1 beta 22`. A ogni modifica di release fai avanzare la beta di 1:
