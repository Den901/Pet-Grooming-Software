...
Release corrente: `0.0.1 beta 21` (`0.0.1-beta.21`).
...
- `Pet-Grooming-Software-0.0.1-beta.21-windows.zip`;
- `Pet-Grooming-Software-0.0.1-beta.21-linux.tar.gz`;
- `Pet-Grooming-Software-0.0.1-beta.21.pgs-update`;
...
1. Estrai `Pet-Grooming-Software-0.0.1-beta.21-windows.zip`.
...
1. Copia `Pet-Grooming-Software-0.0.1-beta.21-linux.tar.gz` sul server.
2. Estrai il pacchetto e entra nella cartella:

```bash
tar -xzf Pet-Grooming-Software-0.0.1-beta.21-linux.tar.gz
cd Pet-Grooming-Software-0.0.1-beta.21
```
...
La release corrente e `0.0.1 beta 21`. A ogni modifica di release fai avanzare la beta di 1:
