...
Release corrente: `1.0.7` stabile.
...
- `Pet-Grooming-Software-1.0.7-windows.zip`;
- `Pet-Grooming-Software-1.0.7-linux.tar.gz`;
- `Pet-Grooming-Software-1.0.7.pgs-update`;
...
1. Estrai `Pet-Grooming-Software-1.0.7-windows.zip`.
...
1. Copia `Pet-Grooming-Software-1.0.7-linux.tar.gz` sul server.
2. Estrai il pacchetto e entra nella cartella:

```bash
tar -xzf Pet-Grooming-Software-1.0.7-linux.tar.gz
cd Pet-Grooming-Software-1.0.7
```
...
La release corrente e `1.0.7` stabile. Per preparare i pacchetti della versione impostata in `package.json`:
