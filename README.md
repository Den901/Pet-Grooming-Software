...
Release corrente: `1.0.2` stabile.
...
- `Pet-Grooming-Software-1.0.2-windows.zip`;
- `Pet-Grooming-Software-1.0.2-linux.tar.gz`;
- `Pet-Grooming-Software-1.0.2.pgs-update`;
...
1. Estrai `Pet-Grooming-Software-1.0.2-windows.zip`.
...
1. Copia `Pet-Grooming-Software-1.0.2-linux.tar.gz` sul server.
2. Estrai il pacchetto e entra nella cartella:

```bash
tar -xzf Pet-Grooming-Software-1.0.2-linux.tar.gz
cd Pet-Grooming-Software-1.0.2
```
...
La release corrente e `1.0.2` stabile. Per preparare i pacchetti della versione impostata in `package.json`:
