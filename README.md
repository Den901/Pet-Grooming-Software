...
Release corrente: `0.0.1 beta 17` (`0.0.1-beta.17`).
...
- `Pet-Grooming-Software-0.0.1-beta.17-windows.zip`;
- `Pet-Grooming-Software-0.0.1-beta.17-linux.tar.gz`;
- `Pet-Grooming-Software-0.0.1-beta.17.pgs-update`;
...
1. Estrai `Pet-Grooming-Software-0.0.1-beta.17-windows.zip`.
...
1. Copia `Pet-Grooming-Software-0.0.1-beta.17-linux.tar.gz` sul server.
2. Estrai il pacchetto e entra nella cartella:

```bash
tar -xzf Pet-Grooming-Software-0.0.1-beta.17-linux.tar.gz
cd Pet-Grooming-Software-0.0.1-beta.17
```
...
La release corrente e `0.0.1 beta 17`. A ogni modifica di release fai avanzare la beta di 1:
